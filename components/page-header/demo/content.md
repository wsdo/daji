...
const content = (
  <div className="content">
    <Paragraph>
      Daji Design interprets the color system into two levels: a system-level color system and a
      product-level color system.
    </Paragraph>
    <Paragraph>
      Daji Design&#x27;s design team preferred to design with the HSB color model, which makes it
