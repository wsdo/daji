module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro.v4': 'Daji Design Pro v4',
    ...
    'app.home.components-explain':
      'Based on the Daji Design language, we have provided a suite of out-of-the-box with high quality for developing and serving enterprise background applications, including the official React UI library and Angular, Vue implementations',
    'app.home.product-pro-slogan': 'Out-of-the-box front-end / Design solution',
    'app.home.product-mobile-slogan':
      "antd-mobile is the implementation of Daji Design's mobile specification",
    'app.home.product-landing-slogan':
      'Landing Pages templates and specifications based of Daji Design language',
    ...
    'app.home.tool-package-title': 'Daji Design Resources',
    'app.home.tool-package-content': 'Daji Design Resources Download',
    ...
    'app.home.more-mobile-react': 'Daji Design Mobile of React',
    'app.home.more-mobile-angular': 'Daji Design Mobile of Angular',
    'app.footer.repo': 'GitHub Repository',
    'app.footer.awesome': 'Awesome Daji Design',
    'app.footer.course': 'Daji Design Practical Tutorial',
    ...
    'app.footer.zhihu': 'Daji Design Blog',
